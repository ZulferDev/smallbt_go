...
func TestPortfolioOpenPosition(t *testing.T) {
	...
	p.OpenPosition(symbol, PositionSideLong, 50000.0, time.Now())
...
func TestPortfolioClosePositionLong(t *testing.T) {
	...
	// Open long position
	p.OpenPosition(symbol, PositionSideLong, 50000.0, now)
...
func TestPortfolioClosePositionShort(t *testing.T) {
	...
	// Open short position
	p.OpenPosition(symbol, PositionSideShort, 50000.0, now)
...
func TestPortfolioMultiplePositions(t *testing.T) {
	...
	p.OpenPosition(market.Symbol("BTCUSDT"), PositionSideLong, 50000.0, now)
	p.OpenPosition(market.Symbol("ETHUSDT"), PositionSideLong, 3000.0, now)
...
func TestPortfolioGetExposure(t *testing.T) {
	...
	assert.Equal(t, 55000.0+3200.0, exposure)
}
