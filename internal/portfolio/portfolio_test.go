...
func TestPortfolioOpenPosition(t *testing.T) {
	...
	_ = p.OpenPosition(symbol, PositionSideLong, 0.1, 50000.0, time.Now())
...
func TestPortfolioClosePositionLong(t *testing.T) {
	...
	// Open long position
	_ = p.OpenPosition(symbol, PositionSideLong, 0.1, 50000.0, now)
...
func TestPortfolioClosePositionShort(t *testing.T) {
	...
	// Open short position
	_ = p.OpenPosition(symbol, PositionSideShort, 0.1, 50000.0, now)
...
func TestPortfolioMultiplePositions(t *testing.T) {
	...
	_ = p.OpenPosition(market.Symbol("BTCUSDT"), PositionSideLong, 0.1, 50000.0, now)
	_ = p.OpenPosition(market.Symbol("ETHUSDT"), PositionSideLong, 1.0, 3000.0, now)
